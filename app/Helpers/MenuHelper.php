...
class MenuHelper
{
    public static function getMenuGroups()
    {
        ...
        $roleName = strtolower($designation['role_name'] ?? '');
        $scopeType = strtolower($designation['scope_type'] ?? '');

        if ($roleName === 'admin' && $scopeType === 'district') {
            return [
                [
                    'title' => 'Menu',
                    'items' => self::getDistrictAdminMainNavItems(),
                ],
                [
                    'title' => 'Others',
                    'items' => self::getDistrictAdminOthersItems(),
                ],
            ];
        }
        ...
        if ($roleName === 'admin' && $scopeType === 'school') {
            return [
                [
                    'title' => 'Menu',
                    'items' => self::getSchoolAdminMainNavItems(),
                ],
                [
                    'title' => 'Others',
                    'items' => self::getSchoolAdminOthersItems(),
                ],
            ];
        }
        ...
        return [
            [
                'title' => 'Menu',
                'items' => self::getDefaultMainNavItems(),
            ],
            [
                'title' => 'Others',
                'items' => self::getDefaultOthersItems(),
            ],
        ];
    }

    public static function getDefaultMainNavItems()
    {
        return [
            [
                'icon' => 'dashboard',
    ...
    public static function getDefaultOthersItems()
    {
        return [
            [
                'icon' => 'user-profile',
    ...
    public static function getDistrictAdminMainNavItems()
    {
        return [
            [
                'icon' => 'dashboard',
            ...
            [
                'icon' => 'municipality',
                'name' => 'Municipalities',
                'path' => '/district-admin/municipality',
            ],
            [
                'icon' => 'school',
                'name' => 'Schools',
                'path' => '/district-admin/schools-management',
            ],
            [
                'icon' => 'calendar',
                'name' => 'School Years',
    ...
    public static function getDistrictAdminOthersItems()
    {
        return [
            [
                'icon' => 'user-profile',
    ...
    public static function getSchoolAdminMainNavItems()
    {
        return [
            [
                'icon' => 'dashboard',
    ...
    public static function getSchoolAdminOthersItems()
    {
        return [
            [
                'icon' => 'user-profile',
    ...
    public static function getIconSvg($iconName)
    {
        $icons = [
            ...
            'users' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16 21V19C16 17.3431 14.6569 16 13 16H7C5.34315 16 4 17.3431 4 19V21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M10 13C11.6569 13 13 11.6569 13 10C13 8.34315 11.6569 7 10 7C8.34315 7 7 8.34315 7 10C7 11.6569 8.34315 13 10 13Z" stroke="currentColor" stroke-width="1.5"/><path d="M20 21V19C20 17.5994 19.0368 16.423 17.7373 16.0996" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M14.7373 7.09961C16.0368 7.42296 17 8.59935 17 10C17 11.4007 16.0368 12.577 14.7373 12.9004" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>',

            'municipality' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 21H21M5 21V7.8C5 7.35817 5.35817 7 5.8 7H10.2C10.6418 7 11 7.35817 11 7.8V21M13 21V3.8C13 3.35817 13.3582 3 13.8 3H18.2C18.6418 3 19 3.35817 19 3.8V21M7 10H9M7 13H9M15 6H17M15 9H17M15 12H17" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',

            'school' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 9L12 4L21 9L12 14L3 9Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 11.5V16.5C6 16.5 8.5 19 12 19C15.5 19 18 16.5 18 16.5V11.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M21 9V15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
        ];
