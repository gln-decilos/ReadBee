...
<aside id="sidebar"
    ...
    <div class="pt-4 pb-2 flex"
        ...
        <a href="/district-supervisor/dashboard" class="mx-auto">
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="dark:hidden" src="/images/logo/logo.png" alt="Logo" width="140" height="40" />

            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="hidden dark:block" src="/images/logo/logo-dark.png" alt="Logo" width="140" height="40" />

            <img x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
                src="/images/logo/logo-icon.png" alt="Logo" width="35" height="35" />
        </a>
    </div>
                                    ...
                                    @if (isset($item['subItems']))
                                        <button @click="toggleSubmenu({{ $groupIndex }}, {{ $itemIndex }})"
                                            ...
                                            <span :class="isSubmenuOpen({{ $groupIndex }}, {{ $itemIndex }}) ? 'menu-item-icon-active' : 'menu-item-icon-inactive'">
                                                {!! DistrictSupervisorMenuHelper::getIconSvg($item['icon']) !!}
                                            </span>
