...
class DistrictSupervisorMenuHelper
{
    public static function getMainNavItems()
    {
        return [
            [
                'icon' => 'dashboard',
                'name' => 'Dashboard',
                'path' => '/district-supervisor/dashboard',
            ],
            [
                'icon' => 'monitoring',
                'name' => 'Progress Monitoring',
                'path' => '/district-supervisor/progress-monitoring',
            ],
            [
                'icon' => 'reports',
                'name' => 'Reports',
                'path' => '/district-supervisor/reports',
            ],
        ];
    }
    ...
    public static function getOthersItems()
    {
        return [
            [
                'icon' => 'user-profile',
                'name' => 'Profile',
                'path' => '/district-supervisor/profile',
            ],
        ];
    }
